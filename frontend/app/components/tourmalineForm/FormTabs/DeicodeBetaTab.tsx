...
export default function DeicodeBetaTab({ register, errors }: { register: any; errors: FieldErrors<any> }) {
	return (
		<div>
			<div className="text-center my-4">
				<h1 className="text-3xl font-bold text-secondary">Deicode Beta Diversity</h1>
			</div>
