...
export const SampleSchema = z.object({
  ...
  eventDate: z.string(),
  eventDurationValue: z.number().nullish(),
  ...
  env_medium: z.string(),
  habitat_natural_artificial_0_1: z.boolean().nullish(),
  ...
  filter_passive_active_0_1: z.boolean().nullish(),
  filter_onsite_dur: z.string().nullish(),
  size_frac_low: z.number().nullish(),
  ...
  dna_cleanup_0_1: z.boolean().nullish(),
...
export const AssaySchema = z.object({
  ...
  annealingTemp: z.number().nullish(),
